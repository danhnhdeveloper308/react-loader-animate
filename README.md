...
> A collection of **162+ animated loading components** built with React, TypeScript, and Tailwind CSS — lightweight, tree-shakable, and fully customizable.
...
- 🎨 **162+ loader animations** — spin, pulse, wave, orbit, DNA, hourglass, and more
