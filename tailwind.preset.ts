...
/**
 * Tailwind CSS preset for react-loader-animate.
 *
 * Add this preset to your tailwind.config.ts to use the library components
 * without importing the pre-built CSS file:
 *
 * @example
 * // tailwind.config.ts
 ...
 * } satisfies Config;
 */
const loaderPreset: Partial<Config> = {
  theme: {
    extend: {
      colors: {
        primary: {
