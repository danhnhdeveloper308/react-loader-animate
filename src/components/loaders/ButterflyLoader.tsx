...
export const ButterflyLoader = memo(({ size = 'md', variant = 'primary' }: LoaderProps) => {
  const bg = LOADER_BG_VARIANTS[variant];
  return (
    <div className={`${LOADER_SIZES[size]} relative flex items-center justify-center animate-butterfly-flap`}>
      {/* Left wing */}
